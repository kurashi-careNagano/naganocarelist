...
// ========== DEMO DATA ==========
const INIT_STAFF = [
  {id:"admin1", name:"斎藤 志穂子", role:"admin", email:"ouchishopirodori@gmail.com", password:"carelist123", phone:"080-3412-8639", assignedClientIds:[1,2], shiftRequests:[], confirmedShifts:[]},
  {id:"staff1", name:"白井 梓",     role:"staff",  email:"misaki@care.jp",  password:"staff123", phone:"090-1111-2222", assignedClientIds:[1], shiftRequests:[], confirmedShifts:[]},
